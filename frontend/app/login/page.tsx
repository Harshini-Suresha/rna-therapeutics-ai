    ...
    <div className="flex min-h-screen bg-[#F5F6FA]">
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-[22px] font-bold text-slate-900">Sign in</h1>
          <p className="mt-1 text-[13px] text-slate-500">Welcome back. Enter your credentials.</p>
          ...
          <p className="mt-6 text-center text-[12px] text-slate-500">
            ...
            <a href="/signup" className="font-medium text-indigo-600 hover:text-indigo-700">Sign up</a>
          </p>
        </div>
      </div>
    </div>
