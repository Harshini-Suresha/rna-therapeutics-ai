...
function spliceColor(pct: number): string {
...
export default function IsoformScoreChart({
  candidates,
}: {
  ...
  const W = 760;
  const PAD = { top: 16, right: 80, bottom: 36, left: 52 };
  const rowH = 42;
  ...
  return (
    <div className="w-full overflow-x-auto">
      ...
      >
        ...
        {candidates.map((c, i) => {
          const bw = (c.spliceEfficiency / maxScore) * plotW;
          const y = rowY(i) - 10;
          ...
          return (
            <g key={c.constructId}>
              ...
              <rect
                ...
                height={20}
                rx={4}
                fill={spliceColor(c.spliceEfficiency)}
