  ...
  return (
    <aside className="hidden lg:flex lg:w-64 shrink-0 flex-col bg-gradient-to-b from-navy-950 to-navy-900 text-white h-screen sticky top-0">
      ...
      <div className="flex items-center gap-2.5 px-5 py-5 border-b border-white/10">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-400 to-blue-600">
      ...
      <div className="border-t border-white/10 px-3 py-4">
        ...
        <button
          onClick={() => window.location.href = "/upload-sequence"}
