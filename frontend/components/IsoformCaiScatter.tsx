...
export default function IsoformCaiScatter({
  candidates,
}: {
          ...
          return (
            <g>
              ...
              <text x={boxX + 10} y={boxY + 36} className="fill-slate-300" fontSize={12}>
                CAI {c.cai.toFixed(3)} · U% {c.uContent.toFixed(1)} · Splice {c.spliceEfficiency}%
              </text>
              <text x={boxX + 10} y={boxY + 54} className="fill-slate-300" fontSize={12}>
                MFE {c.mfe.toFixed(1)} kcal/mol
              </text>
            </g>
          );
        })()}
